...
/*
If statement
returns type just like Ocaml
infer type for TCode with arg T
infer type for FCode with arg T
T gets binded to the result of type infer of TCode and FCode.
*/
